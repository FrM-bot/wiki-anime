...
const People = ({ people }: IProps) => {
  ...
  // const { data: people }: IResponse = useFetch('https://api.jikan.moe/v4/people/1868/full')
  console.log(people)
  return (
    <Layout>
      <>
        <div className='flex flex-wrap gap-2 my-2'>
          ...
          <ValidateAndRender dataToValidate={[people?.given_name?.length]}>
            <Card className='w-fit'>
              <h2>{people?.given_name}</h2>
            </Card>
          </ValidateAndRender>
        </div>
